...
JUDGE_BASE_URL = os.getenv("REGRAG_JUDGE_BASE_URL", LLM_BASE_URL)
JUDGE_API_KEY = os.getenv("REGRAG_JUDGE_API_KEY", LLM_API_KEY)
JUDGE_TIMEOUT = float(os.getenv("REGRAG_JUDGE_TIMEOUT", str(LLM_TIMEOUT)))
